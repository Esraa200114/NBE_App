                ...
                <View>
                    ...
                    <SafeAreaView style={{ height: "100%" }}>
                        ...
                        <View style={{ position: 'absolute', bottom: 0, left: 0, right: 0, marginVertical: 17 }}>
                            <Pressable style={{ backgroundColor: activeColors.MistyLavender, paddingVertical: 8, borderRadius: 13, paddingHorizontal: 8, marginHorizontal: 20, marginVertical: 5 }} onPress={showLogoutAlert}>
